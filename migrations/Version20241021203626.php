 ...
 */
final class Version20241021203626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD islocked TINYINT(1) NOT NULL, ADD roles JSON NOT NULL COMMENT \'(DC2Type:json)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP islocked, DROP roles');
    }
}
